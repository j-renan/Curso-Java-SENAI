 ...
 * @author Aluno
 */
public class DescontoV2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Produto desconto = new Produto(valorProduto, porcentagemDesconto);
        
        float valorDoDesconto = desconto.calcularValorDoDesconto();
        float produtoComDesconto = desconto.calcularPrecoComDesconto();
        
        String mensagem = desconto.Mensagem(valorProduto, valorDoDesconto, produtoComDesconto);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DescontoV2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DescontoV2().setVisible(true);
            }
        });
    }
